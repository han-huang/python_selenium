...
subject ='Real 14 email html test'
...
"""
MIMEText(html_msg, 'html', 'utf-8')
html_attach = MIMEText(html_msg,'html', 'utf-8')
# html_attach["Content-Disposition"] = 'attachment; filename="attach.html"'  # not attach, embed 
msg.attach(html_attach)

# embed jpg file to html
att2 = MIMEImage(open('real-14.jpg','rb').read())
att2.add_header('Content-ID', '<image1>') # for <img src="cid:image1">
msg.attach(att2)
