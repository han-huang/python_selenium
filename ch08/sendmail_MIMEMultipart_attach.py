...
with open('log.txt', 'rb') as fp:
    txt_data = fp.read()
att1 = MIMEText(txt_data, 'base64', 'utf-8')
...
# att2 = MIMEImage(open('real-10.jpg','rb').read())
with open('real-10.jpg', 'rb') as fp:
    img_data = fp.read()
att2 = MIMEImage(img_data)
img = '10th_anniversary.jpg'
att2.add_header('Content-Disposition', "attachment; filename= %s" % img)
msg.attach(att2)
