...
sender = user_account
# mail_to = input("Enter your recipient:")
# mail_cc = input("Enter your cc:")
# mail_bcc = input("Enter your bcc:")

subject ='Python email test'
# msg = MIMEText('<html><h1>你好 測試中</h1></html>', 'html', 'utf-8')
msg = MIMEText('你好, 測試中!!!', 'plain', 'utf-8')
